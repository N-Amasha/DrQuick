...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        if (!empty($password)) {
            ...
            mysqli_stmt_bind_param($update, "ssssi", $fullname, $email, $contact, $hashedPassword, $patient_id);
        } else {
            $update = mysqli_prepare($conn, "UPDATE users SET fullname=?, email=?, contact=? WHERE id=?");
            mysqli_stmt_bind_param($update, "sssi", $fullname, $email, $contact, $patient_id);
        }
...
<body class="dashboard-body">
    ...
    <div class="welcome-section">
        ...
        <p class="tagline">Update your personal details and secure your account.</p>
    </div>

    <div class="profile-card-container">
        <div class="action-card profile-main-card">
